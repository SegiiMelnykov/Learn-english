...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"refreshData\": () => (/* binding */ refreshData),\n/* harmony export */   \"words\": () => (/* binding */ words)\n/* harmony export */ });\n/* harmony import */ var _styles_main_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../styles/main.scss */ \"./source/styles/main.scss\");\n/* harmony import */ var easy_speech__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! easy-speech */ \"./node_modules/easy-speech/index.js\");\n/* harmony import */ var _swipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./swipe */ \"./source/js/swipe.js\");\n/* harmony import */ var _swipe__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_swipe__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _getData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getData */ \"./source/js/getData.js\");\n/* harmony import */ var _lib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./lib */ \"./source/js/lib.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nlet words = []\r\nlet id = 0\r\n;\r\n\r\n\r\n\r\n\r\nfunction refreshData() {\r\n    const promise = new Promise((resolve, reject) => {\r\n      resolve((0,_getData__WEBPACK_IMPORTED_MODULE_3__.getData)())\r\n    })\r\n    promise.then(result => {\r\n      words = result\r\n    }).then(()=>{\r\n      if(words.length > 0) {\r\n            (0,_lib__WEBPACK_IMPORTED_MODULE_4__.saveDataToLocalStorage)()\r\n            ;(0,_lib__WEBPACK_IMPORTED_MODULE_4__.showWord)(id)\r\n          }\r\n    })\r\n}\r\n\r\n\r\nasync function start() {\r\n  let cashe = []\r\n  await console.log('before get cashe')\r\n  cashe = await (0,_getData__WEBPACK_IMPORTED_MODULE_3__.getLocalStorege)()\r\n  await console.log('after got cashe')\r\n  if (cashe && cashe.length > 0) {\r\n    console.log('first condition')\r\n    words =  await cashe\r\n    await (0,_lib__WEBPACK_IMPORTED_MODULE_4__.setTotalWords)()\r\n    await (0,_lib__WEBPACK_IMPORTED_MODULE_4__.showWord)(id)\r\n  } else {\r\n    await console.log('second condition')\r\n    await refreshData()\r\n  }\r\n  await console.log('finish')\r\n}\r\n\r\nstart()\r\n\r\n\r\n\r\n\r\n\r\n  \n\n//# sourceURL=webpack://word-learning/./source/js/script.js?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("4916659040f0a3fa184d")
/******/ 	})();
/******/ 	
